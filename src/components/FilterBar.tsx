...
export const FilterBar = () => {
  ...
  return (
    <div className="bg-white border-b border-gray-200 px-4 md:px-6 py-2.5 flex items-center gap-4 md:gap-6 flex-nowrap text-sm relative z-30 shadow-sm transition-all overflow-x-auto custom-scrollbar scroll-smooth">
      
      {/* Status multi-select seamlessly constructed as toggle pills */}
      <div className="flex items-center gap-2 flex-shrink-0">
        <span className="font-semibold text-gray-700 tracking-tight hidden sm:block">Status:</span>
      ...
      <div className="flex items-center gap-1.5 md:gap-2 border-l border-gray-200 pl-4 md:pl-6 flex-shrink-0">
        <span className="font-semibold text-gray-700 tracking-tight hidden sm:block">Assignee:</span>
      ...
      <div className="flex items-center gap-1.5 md:gap-2 border-l border-gray-200 pl-4 md:pl-6 flex-shrink-0">
        <span className="font-semibold text-gray-700 tracking-tight flex items-center gap-1.5 hidden sm:flex">
      ...
      <div className="flex-1 flex justify-end flex-shrink-0 pl-4">
        {hasFilters && (
          <button 
